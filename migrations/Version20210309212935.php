 ...
 */
final class Version20210309212935 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE meal_ingredients (meal_id INT NOT NULL, ingredient_id INT NOT NULL, INDEX IDX_469A17C7639666D6 (meal_id), INDEX IDX_469A17C7933FE08C (ingredient_id), PRIMARY KEY(meal_id, ingredient_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meal_tags (meal_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_756247D2639666D6 (meal_id), INDEX IDX_756247D2BAD26311 (tag_id), PRIMARY KEY(meal_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE meal_ingredients ADD CONSTRAINT FK_469A17C7933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE meal_tags ADD CONSTRAINT FK_756247D2639666D6 FOREIGN KEY (meal_id) REFERENCES meal (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE meal_tags ADD CONSTRAINT FK_756247D2BAD26311 FOREIGN KEY (tag_id) REFERENCES tag (id) ON DELETE CASCADE');
    }
